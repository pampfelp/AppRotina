...
if (!configurado) {
  ...
  observarSessao({
    aoEntrar: entrar,
    aoSair: deslogar,
    // conta criada mas e-mail ainda não confirmado: fecha tudo como se
    // estivesse deslogado e troca a tela de login pela de confirmação
    aoNaoConfirmado: (user) => { deslogar(); montarTelaConfirmacao(user); },
  });
}
