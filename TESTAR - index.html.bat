...
echo.
echo IMPORTANTE: a porta %PORTA% precisa estar autorizada no Firebase Auth
echo (Authentication ^> Settings ^> Authorized domains: localhost) e nas
echo origens do cliente OAuth (http://localhost:%PORTA%), senao o login
echo Google e o Google Agenda vao recusar a conexao.
echo.
